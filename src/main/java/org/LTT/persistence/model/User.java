...
//    public Collection<University> getUniversity() {
//        return university;
//    }
    ...
    public String toString() {
        ...
        builder.append("User [id=").append(id).append(", firstName=").append(firstName).append(", lastName=").append(lastName).append(", email=").append(email).append(", password=").append(password).append(", enabled=").append(enabled).append(", isUsing2FA=")
                .append(isUsing2FA).append(", secret=").append(secret) .append(", university=").append(university) .append(", companyCards=").append(companyCards) .append(", roles=").append(roles).append(", companyCards=").append(companyCards).append("]");
